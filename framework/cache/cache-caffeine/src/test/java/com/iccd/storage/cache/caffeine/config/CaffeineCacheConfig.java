...
@EnableCaching
@Slf4j
@ComponentScan(value = StorageConstants.BASE_COMPONENT_SCAN_PATH+".cache.caffeine.test")
public class CaffeineCacheConfig {
    ...
    public CacheManager caffeineCacheManager() {
        CaffeineCacheManager cacheManager = new CaffeineCacheManager(CacheConstants.ICCD_STORAGE_CACHE_NAME);
