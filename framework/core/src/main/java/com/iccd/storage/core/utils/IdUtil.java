...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new StorageBusinessException("AES128Util.aesDecode fail");
        }
        throw new StorageBusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(StorageConstants.COMMON_SEPARATOR).splitToList(decryptIdStr);
    ...
    public static void main(String[] args) {
        System.out.println(encrypt(1680455517879562240L));
