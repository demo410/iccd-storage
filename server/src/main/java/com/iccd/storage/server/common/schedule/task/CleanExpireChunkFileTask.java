package com.iccd.storage.server.common.schedule.task;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.iccd.storage.core.constants.StorageConstants;
import com.iccd.storage.engine.core.StorageEngine;
import com.iccd.storage.engine.core.context.DeleteRealFileContext;
import com.iccd.storage.schedule.ScheduleTask;
...
//        log.info("{} finish clean expire chunk file...", getName());
    ...
    private void saveErrorLog(List<String> realPaths) {
        ErrorLogEvent event = new ErrorLogEvent(this,"文件物理删除失败，请手动执行文件删除！文件路径为：" + JSON.toJSONString(realPaths),
                StorageConstants.ZERO_LONG);
