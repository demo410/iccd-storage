package com.iccd.storage.server;
...
@SpringBootApplication(scanBasePackages = StorageConstants.BASE_COMPONENT_SCAN_PATH)
@ServletComponentScan(basePackages = StorageConstants.BASE_COMPONENT_SCAN_PATH)
@EnableTransactionManagement
@MapperScan(basePackages = StorageConstants.BASE_COMPONENT_SCAN_PATH + ".server.modules.**.mapper")
@Slf4j
public class StorageServerLauncher {

    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(StorageServerLauncher.class);
